$(document).ready(function () {
  var myQuestions = [
    {
      ...
      answers: ["Rocky Moutian Goat", "Big Foot", "Ovis Canadensis", "Moose"],
    ...
    },
    {
      ...
      answers: ["Daisy", "Columbine", "Sunflower", "Kush"],
      correctAnswer: "Columbine",
    },
    {
      questions: "What is Colorado's State fruit?",
      answers: ["Green Apples", "Grapes", "Palisade Peach", "Oranges"],
      correctAnswer: "Palisade Peach",
    },
    {
      questions: "What is Colorado's most famous Boxer?",
      answers: ["Muhammad Ali", "Rocky Marciano", "Mike Tyson", "Jack Dempsey"],
  ...
  function startQuiz() {
    ...
    for (let i = 0; i < myQuestions.length; i++) {
      ...
      for (let j = 0; j < myQuestions[i].answers.length; j++) {
        $(".questions").append(
          "<br><input type='radio' name='question-" +
            i +
            "'value='" +
  ...
  function displayResults() {
    ...
    $(".questions").append("<h3> CORRECT ANSWERS: " + correct + "</h3>");
